...
export class FinanceService {
    ...
    private readonly apiUrl = environment.financeApiUrl;
    private readonly twelveDataApiKey = '25bff65f25b84c3dbed730c207e431b8';
    private readonly twelveDataApiUrl = 'https://api.twelvedata.com';
