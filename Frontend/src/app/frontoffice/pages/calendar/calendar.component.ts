...
export class CalendarComponent implements AfterViewInit, OnDestroy {
  ...
  private readonly eventsApiUrl = 'http://localhost:8081/Event/all';
  private readonly eventBaseUrl = 'http://localhost:8081/Event';
  private readonly inscriptionBaseUrl = 'http://localhost:8082/Inscription';
  private readonly feedbackBaseUrl = 'http://localhost:8086/Feedback';
  private readonly recommendationBaseUrl = 'http://localhost:8081/api/recommendations';
