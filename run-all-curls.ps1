...
$adminUser = PostJson "$base/api/auth/signup" @{ username=$adminUsername; firstName='Admin'; lastName='Tester'; email=$adminEmail; password='password123'; confirmPassword='password123'; role='ADMIN'; age=28; address='Ops Lane'; sex='F' }
AssertNotNull $adminUser 'signup admin user'
$adminId = $adminUser.userId

$user1 = PostJson "$base/api/auth/signup" @{ username=$username1; firstName='Yassin'; lastName='Test'; email=$email1; password='password123'; confirmPassword='password123'; role='USER'; age=25; address='123 Main St'; sex='M' }
AssertNotNull $user1 'signup user1'
$u1Id = $user1.userId

$user2 = PostJson "$base/api/auth/signup" @{ username=$username2; firstName='Sara'; lastName='Company'; email=$email2; password='password123'; confirmPassword='password123'; role='ENTERPRISE_USER'; age=30; address='HQ Street'; sex='F'; companyName='Acme Corp'; enterpriseCompanyId='Acme Corp' }
AssertNotNull $user2 'signup enterprise user'
$u2Id = $user2.userId

$userSignIn = PostJson "$base/api/auth/signin" @{ email=$email1; password='password123' }
...
$adminSignIn = PostJson "$base/api/auth/signin" @{ email=$adminEmail; password='password123' }
...
PostJson ("$base/api/ban-appeals/$aId/approve?reviewedBy=admin") @{} | Out-Null
PostJson ("$base/api/ban-appeals/$aId/reject?reviewedBy=admin") @{} | Out-Null
