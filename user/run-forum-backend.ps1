...
Write-Host " - Thread Service     http://localhost:8083"
Write-Host " - Post Service       http://localhost:8084"
Write-Host " - Comment Service    http://localhost:8085"
Write-Host " - Messaging Service  http://localhost:8086"
...
$serviceDefinitions = @(
    ...
    @{ Name = "Thread Service"; Dir = $threadDir; Port = 8083; Health = "http://localhost:8083/actuator/health"; EurekaName = "thread-service" },
    @{ Name = "Post Service"; Dir = $postDir; Port = 8084; Health = "http://localhost:8084/actuator/health"; EurekaName = "post-service" },
    @{ Name = "Comment Service"; Dir = $commentDir; Port = 8085; Health = "http://localhost:8085/actuator/health"; EurekaName = "comment-service" },
    @{ Name = "Messaging Service"; Dir = $messagingDir; Port = 8086; Health = "http://localhost:8086/actuator/health"; EurekaName = "messaging-service" },
...
$mainServices = @(
    @{ Name = "User Service"; Dir = $userDir; Port = $UserPort; Health = "http://localhost:$UserPort/actuator/health"; EurekaName = "user-service"; Env = @{ SERVER_PORT = "$UserPort" } },
    @{ Name = "Category Service"; Dir = $categoryDir; Port = $CategoryPort; Health = "http://localhost:$CategoryPort/actuator/health"; EurekaName = "category-service"; Env = @{ SERVER_PORT = "$CategoryPort" } },
    @{ Name = "Thread Service"; Dir = $threadDir; Port = 8083; Health = "http://localhost:8083/actuator/health"; EurekaName = "thread-service"; Env = @{} },
    @{ Name = "Post Service"; Dir = $postDir; Port = 8084; Health = "http://localhost:8084/actuator/health"; EurekaName = "post-service"; Env = @{} },
    @{ Name = "Comment Service"; Dir = $commentDir; Port = 8085; Health = "http://localhost:8085/actuator/health"; EurekaName = "comment-service"; Env = @{} },
    @{ Name = "Messaging Service"; Dir = $messagingDir; Port = 8086; Health = "http://localhost:8086/actuator/health"; EurekaName = "messaging-service"; Env = @{} }
)
